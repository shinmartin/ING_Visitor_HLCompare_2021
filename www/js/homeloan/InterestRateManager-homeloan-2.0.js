...
function InterestRateManager() {
	...
	// this.serviceUrl = location.protocol + '//' + location.host + "/ReverseProxy/ProductService/V1/productservice.svc/json/interestrates/currenteffective"; // PRODUCTION
    this.serviceUrl = location.protocol + '//' + location.host + "/js/homeloan/mtg-rafiki2-reverseproxy.json"; // STAGING
	this.enableCount = false;
	this.responseObj;

	// ADDED BY LASH START - notify to angular homeloan controller
